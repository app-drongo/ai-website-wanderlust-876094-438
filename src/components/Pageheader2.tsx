      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative py-16 sm:py-20 lg:py-24 max-w-4xl">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground leading-relaxed max-w-3xl">
            Journey to extraordinary places where few have ventured. From remote tropical paradises to ancient cultural treasures, 
            explore destinations that will transform your perspective and create memories to last a lifetime.
          </p>
        </div>
      </div>
    </section>
