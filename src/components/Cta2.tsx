...
// Position: pages.2.sections.5

import { Button } from "@/components/ui/button"
import { Card, CardContent } from "@/components/ui/card"
import { ArrowRight, Sparkles, Users, Camera, Shield } from "lucide-react"

export default function Cta2() {
  const stats = [
    { value: "500+", label: "Safari Adventures", icon: Camera },
    { value: "98%", label: "Client Satisfaction", icon: Shield },
    { value: "25+", label: "African Destinations", icon: Users },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of adventurous travelers who have experienced the magic of Africa with Wanderlust Adventures. 
                Your extraordinary safari journey awaits.
              </p>
        ...
        <div className="text-center mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Expert Planning</h3>
              <p className="text-sm text-muted-foreground">
                Personalized safari planning with local expertise
              </p>
            </div>
